...
public class SimpleClassPackageImpl extends EPackageImpl implements SimpleClassPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getClass_Parent(), this.getClass_(), null, "parent", null, 0, 1, SimpleClass.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClass_Is_persistent(), ecorePackage.getEBoolean(), "is_persistent", null, 1, 1, SimpleClass.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_Attrs(), this.getAttribute(), null, "attrs", null, 0, -1, SimpleClass.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getAttribute_Is_primary(), ecorePackage.getEBoolean(), "is_primary", null, 1, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
