...
//conditions 1 branches 26
public class MOFJavaSyntaxTrans {
	//conditions 1 branches 2
	public static Node getSignatureOfAllSignals(CFG R, Node parent){
...
//		CFG R =new CFG();
		...
		Node returnNode=getSignalEventJavaSyntax(R,compNode);
//		R.insert(getSignalEventJavaSyntax().getRootNode(),compNode);//--------------f call
		...
		decNode=new DecisionNode("414141#GSOAS4:DecisionNode:C1","s.isComposite");
		...
		atNode1=new AtomicNode("424242#GCF5:then:GSOAS4","Line:42-Line45");
	...
	//	R.insert(getSignatureOfAllSignals().getRootNode(),compNode);//--------------f call
		...
		atNode2=new AtomicNode("53#GSOAS7","Line:53-Line56");
	...
	public static Node getSignatureOfAllOperations(CFG R, Node parent){
		AtomicNode atNode1,atNode2;
		CompositeNode compNode;
...
//		CFG R =new CFG();
		...
		R.insert(compNode, atNode1);
		Node returnNode=getCallEventJavaSyntax(R,compNode);
//		R.insert(getCallEventJavaSyntax().getRootNode(),compNode);//--------------f call
	...
	//conditions 0 branches 1
	public static Node getCallEventJavaSyntax(CFG R, Node parent){
		AtomicNode atNode1,atNode2;
		CompositeNode compNode;
...
//		CFG R =new CFG();
		...
		R.insert(compNode, atNode1);
		Node returnNode=getOperationJavaSignature(R,compNode);
//		R.insert(getOperationJavaSignature().getRootNode(),compNode);//--------------f call
	...
	//conditions 0 branches 1
	public static Node getSignalEventJavaSyntax(CFG R, Node parent){
		
		CompositeNode compNode;
//		CFG R =new CFG();
		
		compNode=new CompositeNode("80#GSEJS1:Comp","self.signal.getSignalJavaSignature()");
		R.insert(compNode, parent);
		Node returnNode=getSignalJavaSignature(R,compNode);
//		R.insert(getSignalJavaSignature().getRootNode(),compNode);//--------------f call
				
		return returnNode;
	}
	//conditions 0 branches 1
	public static Node getSignalJavaSignatureStringContextParam(CFG R, Node parent){
		AtomicNode atNode1,atNode2;
		CompositeNode compNode;
...
//		CFG R =new CFG();
		...
		R.insert(compNode, atNode1);
		Node returnNode=getJavaEquivalent(R,compNode);
//		R.insert(getJavaEquivalent().getRootNode(),compNode);//--------------f call
	...
	//conditions 0 branches 1
	public static Node getSignalJavaSignatureString(CFG R, Node parent){
		AtomicNode atNode1,atNode2;
		CompositeNode compNode;
...
//		CFG R =new CFG();
		...
		R.insert(compNode, atNode1);
		Node retrunNode=getJavaEquivalent(R,compNode);
//		R.insert(getJavaEquivalent().getRootNode(),compNode);//--------------f call
		atNode2=new AtomicNode("135#GSJSS3","Line:135-Line148");
		R.insert(atNode2, retrunNode);
		
		return atNode2;
	}
	//conditions 0 branches 1
	public static Node getSignalJavaSignature(CFG R, Node parent){
		AtomicNode atNode1,atNode2;
		CompositeNode compNode;
...
//		CFG R =new CFG();
		...
		R.insert(compNode, atNode1);
		Node returnNode=getSignalJavaSignatureString(R,compNode);
//		R.insert(getSignalJavaSignatureString().getRootNode(),compNode);//--------------f call
	...
	//conditions 0 branches 1
	public static Node getOperationJavaSignature(CFG R, Node parent){
		AtomicNode atNode1,atNode2;
		CompositeNode compNode;
...
//		R.insert(getJavaEquivalent().getRootNode(),compNode);//--------------f call
	...
	//conditions 0 branches 1
	public static Node getOperationJavaCall(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node getSignalJavaCallAsSignalWithThis(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node getSignalJavaCallAsSignalWithThisNotContext(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node getSignalJavaCallWithThis(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node processTimeEventExpression(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node formatStateName(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node getJavaEquivalent(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node handleAssignmentAction(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node parseActionCodeHavingActionClassCall(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node convertActionToJavaCall(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node convertActionToJavaCallAsString(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node generateMethodNoParam(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node generateMethodWithParam(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node convertToSignalCall(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node surroundWithTryCatch(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node addHashtable(CFG R, Node parent){
		AtomicNode atNode1;
...
//		CFG R =new CFG();
	...
	//conditions 0 branches 1
	public static Node cloneHashtable(CFG R, Node parent){
		AtomicNode atNode1;
