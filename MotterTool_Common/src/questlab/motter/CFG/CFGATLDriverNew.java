...
public class CFGATLDriverNew {

	public CFGATLDriverNew() {
...
//		TP.reInitializeIsVisisted(TP.getRootNode());
	...
	public CFG funRulePersistentClass2Table(){
		...
		R.insert(this.funFlattenedFeature(R, compNode),compNode);
		...
		R.insert(this.funTopParent(R, compNode), compNode);
		compNode1=new CompositeNode("43#R15:Comp", ".flattenedFeatures");
		R.insert(compNode1, compNode);
		R.insert(this.funFlattenedFeature(R, compNode1), compNode1);
...
//U		CFG FF =new CFG();
		...
		FF.insert(this.funTopParent(FF, comp), comp);
		...
		FF.insert(this.funTopParent(FF, compNode), compNode);
		compNode1=new CompositeNode("198#FF4:Comp",".attributesOfSubclasses");
		FF.insert(compNode1, compNode);
		FF.insert(this.funAttributeofSubClasses(FF, compNode1), compNode1);
		//->union(	
		...
		FF.insert(compNode2, compNode);
		FF.insert(this.funAllAssociations(FF, compNode2), compNode2);
	//	atNode3=new AtomicNode("FF5","endif; ");
		...
		FF.insert(atNode1, compNode1);
		atNode1.setParentNode(compNode2);
