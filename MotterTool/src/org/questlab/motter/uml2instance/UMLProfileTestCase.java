 ...
 */
public class UMLProfileTestCase {

	public static boolean DEBUG = true;

	private static File outputDir;

	public static final ResourceSet RESOURCE_SET;
	...
	static {
		...
		String JAR_FILE_ECLIPSE_UML2_UML_RESOURCES = "jar:file:I:/workspace-xp/MotterTool/Lib_Instance2.5-3.1/org.eclipse.uml2.uml.resources_3.1.1.v201008191505.jar!/";
	...
	public static void main(String[] args)
		...
		URI outputURI2 = URI.createFileURI(outputDir.getAbsolutePath())
			.appendSegment("ProfileExtendedPO2")
			.appendFileExtension(UMLResource.FILE_EXTENSION);
		banner("Saving the Model to %s.", outputURI2.toFileString());
		save(epo2Model, outputURI2);
	}
	...
	private static boolean processArgs(String[] args)
		...
		if (args.length != 1) {
			...
			err("Usage: java -jar ... %s <dir>",
				UMLProfileTestCase.class.getSimpleName());
			err("where");
...
//	}
	...
	protected static Profile loadProfile(String FName) {
