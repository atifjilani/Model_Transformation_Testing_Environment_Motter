...
public class Generator {
	...
	public static ArrayList<MatchedRule> extractAllMatchedRules(Collection roots)
			throws IOException {
		...
		while (count > 0) {
			...
			EList<EObject> elements = (EList) eGet(inputPattern, "elements");
			...
			elements = (EList) eGet(outPattern, "elements");
	...
	public static ArrayList<LazyMatchedRule> extractAllLazyMatchedRules(
			Collection roots) throws IOException {
	...
	public static ArrayList<CalledRule> extractAllCalledRules(Collection roots)
			throws IOException {
		...
		while (numOfRules > 0) {
			...
			EObject outPattern = (EObject) eGet(retUnit, "outPattern");
			EList<EObject> elements = (EList) eGet(outPattern, "elements");
	...
	private static Collection getElementsByType(IModel model, String typeName) {
		return model.getElementsByType(model.getReferenceModel()
				.getMetaElementByName(typeName));
	}
	...
	public Reference ExtractExpression(Collection roots,
